    ...
    <li class="dd-item" :class="{ expanded: item.isExpanded || item.items.length === 0 }" :data-id="item.id">
        <div class="sitemap-item" :class="{ dimmed: item.isUnpublished || item.isScheduled }">
            ...
            <div class="link">
                ...
                <a v-if="piranha.permissions.pages.edit & item.isExternalLink==false" :href="piranha.baseUrl + item.editUrl + item.id">
            ...
            <div class="actions">
                <a v-if="piranha.permissions.pages.add & item.isExternalLink==true " href="#" v-on:click.prevent="piranha.pagelist.modalEditOpen(item)"><i class="fas fa-info"></i></a>
